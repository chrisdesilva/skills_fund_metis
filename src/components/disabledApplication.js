		...
		>
			...
			<div className="rounded shadow-2xl p-8 px-8 mx-16 mb-8 bg-white">
				...
				<h3 className="text-center font-normal">
					Looking to apply for Skills Fund financing for {props.schoolName}'s upcoming cohort?
				</h3>
				<p className="text-center font-normal">
					The application button will become available once we're within 90 days of that cohort start date.
					Please submit your email address below to be notified once the application button becomes available.
				</p>
