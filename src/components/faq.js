...
const FAQ = () => (
     <div className="mx-2 lg:mx-10 p-8 shadow rounded">
       ...
       <h3 className="uppercase text-primary">how much are interest payments during the deferment period?</h3>
            ...
            <p><strong>For a 36-month $10,000 loan:</strong> The interest rate is fixed at 8.99% / 11.16% estimated APR. The interest-only monthly payment is approximately $77.91.</p>
            <p><strong>For a 60-month $10,000 loan:</strong> The interest rate is fixed at 10.99% / 12.51% estimated APR. The interest-only monthly payment is approximately $95.25.</p>
