...
const FAQ = () => (
    <div className="border-2 border-gray-300 shadow-xl rounded-lg m-2 lg:m-10 p-8">
       ...
       <h3 className="uppercase text-secondary">how much can i borrow and for what specific uses?</h3>
            <p><strong>For Make School's Bachelor's in Applied CS,</strong> you may borrow from $2,000 to $70,000 for tuition.</p>
       ...
       <h3 className="uppercase text-secondary">how much are interest payments during the deferment period?</h3>
            ...
            <p><strong>For an 84-month $70,000 loan:</strong> The interest rate is fixed at XX.XX% / XX.XX% estimated APR. The interest-only monthly payment is approximately $XX.XX.</p>
