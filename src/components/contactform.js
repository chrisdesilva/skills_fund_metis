    ...
    render() {
        return (
            <div className="border-2 border-gray-300 shadow-xl rounded-lg m-2 lg:m-10 p-8">
                ...
                {/* <form className="text-center" name="make_school_contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field" onSubmit={this.handleSubmit}>
                    ...
                    <div className="w-full mb-8">
                        ...
                        <input onChange={this.handleChange} value={this.state.name} name="name" className="shadow appearance-none border w-1/3 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Your name" required/>
                    </div>
                    <div className="w-full mb-8">
                        <label className="block text-gray-700 text-sm font-bold" htmlFor="email">Email</label>
                        <input onChange={this.handleChange} value={this.state.email} name="email" className="shadow appearance-none border w-1/3 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" placeholder="Your email address" required/>
                    </div>
                    <div className="w-full mb-8">
                        <label className="block text-gray-700 text-sm font-bold" htmlFor="school">School Name</label>
                        <input onChange={this.handleChange} name="school" value={this.state.school} className="shadow appearance-none border w-1/3 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Name of your school" required/>
                    </div>
                    <div className="w-full mb-8 flex flex-col items-center">
                        <label className="block text-gray-700 text-sm font-bold" htmlFor="identity">I am a...</label>
                        <select required name="identity" onChange={this.handleChange} className="block appearance-none w-1/3 bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                    ...
                    <div className="w-full mb-8">
                        ...
                        <textarea onChange={this.handleChange} value={this.state.comments} name="comments" className="shadow appearance-none border w-1/3 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Enter any questions or comments here" required/>
                    </div>
