            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="text-center bg-gray-100" colSpan="2"><strong>Interest-Only Loans:</strong> Interest not capitalized unless payments not made.</td> 
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className="text-center bg-gray-100">36 months (3 years)</td> 
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="text-center bg-gray-100">$2,293.64 (4)</td> 
                        <td className="text-center bg-gray-100">$4,040.39 (5)</td> 
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className="text-center bg-gray-100">$330.67 (4)</td> 
                        <td className="text-center bg-gray-100">$226.07 (5)</td> 
                    </tr>
                </tbody>
            </table>
