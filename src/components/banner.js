...
const Banner = props => (
    <div>
        <div className="flex flex-col justify-center items-center relative z-0" id="banner">
                ...
                <h1 className="text-3xl lg:text-4xl font-normal text-center mt-8 text-black px-4">Experience Immersive Data Science Instruction at Metis</h1>
                ...
                <div className="flex flex-col lg:flex-row pb-16">
                    <Button
                        buttonClassName="opacityApply uppercase bg-primary p-3 w-40 rounded-full shadow-lg text-white"
